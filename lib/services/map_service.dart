    ...
    markers.add(
      Marker(
        ...
        icon: BitmapDescriptor.defaultMarkerWithHue(
            BitmapDescriptor.hueRed), // Red icon for current location
      ),
    );
    ...
    for (var i = 0; i < donationLocations.length; i++) {
      ...
      if (donation.donorId != userId) {
        ...
        DateTime expiryDate = DateTime.parse(
            donation.expiryDate); // Assuming expiryDate is in ISO 8601 format
        ...
        markers.add(
          Marker(
            markerId: MarkerId(
                'donation_${donation.itemName}_$i'), // Make the ID unique
            ...
            icon: BitmapDescriptor.defaultMarkerWithHue(
                BitmapDescriptor.hueGreen), // Green icon for donation markers
